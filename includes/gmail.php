...
function makegcal($row, $temp = 0)
{
	...
	if($temp == 1)
		...
		$gcalname . '&dates=' . $gcaldate . $gcaltime1 . '/' . $gcaldate2 . $gcaltime2 . '&details=&location=' 
		. $gcalplace .'&trp=true&sprop=http%3A%2F%2Fwww.hcs.harvard.edu%2Fcs50-foodfinder%2F&sprop=name:Harvard%20Food%20Finder');
	
	return ('<a href="http://www.google.com/calendar/event?action=TEMPLATE&text=' . 
	$gcalname . '&dates=' . $gcaldate . $gcaltime1 . '/' . $gcaldate2 . $gcaltime2 . '&details=&location=' . 
	$gcalplace .'&trp=true&sprop=http%3A%2F%2Fwww.hcs.harvard.edu%2Fcs50-foodfinder%2F&sprop=name:Harvard%20Food%20Finder" target="_blank">Add to G-Cal</a>');
}
