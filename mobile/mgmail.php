...
function makegcal($row)
{
	...
	return ('<a href="http://www.google.com/calendar/gpcal?hl=en#~calendar:view=e&text=' . 
	...
	F&sprop=name:Harvard%20Food%20Finder" target="_blank">Add to Google<br/>Calendar</a>');
}
