<?php
     ...
     */
    function mapologize($message)
    {
        mrender("mtemplates/apology.php", array("message" => $message));
        exit;
    }
    ...
    {
        mrender("mtemplates/success.php", array("message" => $message));
        exit;
    }
     ...
     */
    function mredirect($destination)
    {
        // handle URL
     ...
     */
    function mrender($template, $values = array())
    {
        ...
        if (file_exists("$template"))
        {
            ...
            // render header
            //require(dirname(__FILE__) . "/../mtemplates/header.php");
            ...
            // render footer
            //require(dirname(__FILE__) . "/../mtemplates/footer.php");
        }
