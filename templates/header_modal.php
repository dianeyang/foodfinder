...
<div id="top" style="overflow:hidden">
		<table id="headertable" class="centeralignment">
			<tr>
				<!-- logo -->
				<td style="width:89px;">
					<a href="/cs50-foodfinder/index2.php" style="text-decoration:none;" onmouseover="changeheader('./html/img/radar-logo-red.png', '#FF3300', '#FF3300')" onmouseout="changeheader('./html/img/radar-logo.png', '#999999', '#000000')">
				...
				<td style="text-align:left; padding-left:10px;">
					<h1 class="pageheader" style="font-size:26px;">
						<a href="/cs50-foodfinder/index2.php" style="text-decoration:none;" onmousemove="changeheader('./html/img/radar-logo-red.png', '#FF3300', '#FF3300')" onmouseout="changeheader('./html/img/radar-logo.png', '#999999', '#000000')">
							<small id="harvard">HARVARD</small>
						</a>
					</h1>
					<h1 class="pageheader">
						<a id="foodfinder" href="/cs50-foodfinder/index2.php" style="text-decoration:none;" onmousemove="changeheader('./html/img/radar-logo-red.png', '#FF3300', '#FF3300')" onmouseout="changeheader('./html/img/radar-logo.png', '#999999', '#000000')">
	...
	<div class="navbar-inner" style="border-radius: 0px; text-transform:uppercase; font-family:'Dosis'; font-weight:bold;">
		...
		<!-- Everything you want hidden at 940px or less, place within here -->
			...
			<!-- .nav, .navbar-search, .navbar-form, etc -->
				...
				<ul class="nav">
					<li class="">
					<a href="/cs50-foodfinder/index2.php">Upcoming Events</a>
					</li>
					<li class="">
					<a href="#myModal" data-toggle="modal" onclick="loadmodal('displaycontents', './templates/addform.php', 'Add an Event')">Manually Add an Event</a>
					</li>
